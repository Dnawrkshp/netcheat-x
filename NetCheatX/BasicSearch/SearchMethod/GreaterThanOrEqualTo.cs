...
namespace BasicSearch.SearchMethod
{
    class GreaterThanOrEqualTo : ISearchMethod
    {
        ...
        public void FirstScan(out List<ISearchResult> result, ISearchType searchType, object[] args, Types.MemoryRange[] range)
        {
            ...
            {
                Search.FirstScan(_host, this, r, ref result, Search.SearchType.GreaterThanOrEqualTo, searchType.Signed, searchType.Alignment, param0);
            }
        }
        ...
        public void NextScan(ref List<ISearchResult> result, ISearchType searchType, object[] args)
        {
            ...
            // Perform scan
            Search.NextScan(_host, this, ref result, Search.SearchType.GreaterThanOrEqualTo, sign, param0);
        }
