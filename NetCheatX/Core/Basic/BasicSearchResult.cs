...
namespace NetCheatX.Core.Basic
{
    ...
    /// </summary>
    public class BasicSearchResult : Interfaces.ISearchResult
    {
        /// <summary>
        ...
        public void ToByteArray(out byte[] bytes)
        {
            ...
            Array.Copy(Bitlogic.EndianBitConverter.DefaultBitConverter.GetBytes(Address), 0, bytes, 0, sizeof(ulong));
        ...
        public void FromByteArray(byte[] bytes)
        {
            ...
            Address = Bitlogic.EndianBitConverter.DefaultBitConverter.ToUInt64(bytes, 0);
        }
