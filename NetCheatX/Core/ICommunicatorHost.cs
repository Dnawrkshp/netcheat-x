...
namespace NetCheatX.Core
{
    ...
    public interface ICommunicatorHost
    {
        ...
        bool RegisterItem(string path, string description, Types.MenuItemCallback callback);
        ...
        bool RegisterItem(Image icon, string description, Types.MenuItemCallback callback);
        ...
        bool RegisterMDIForm(string uniqueName, System.Windows.Forms.Form mdiChild);
    }
}
