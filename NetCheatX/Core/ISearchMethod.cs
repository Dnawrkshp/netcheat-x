...
namespace NetCheatX.Core
{
    ...
    public interface ISearchMethod : IPluginExtension
    {
        ...
        void FirstScan(out List<ISearchResult> result, ISearchType searchType, object[] args, Types.MemoryRange[] range);
        ...
        /// <param name="searchType">ISearchType in use</param>
        /// <param name="args">All arguments in order. Defined by ISearchMethod's Params property</param>
        void NextScan(ref List<ISearchResult> result, ISearchType searchType, object[] args);
